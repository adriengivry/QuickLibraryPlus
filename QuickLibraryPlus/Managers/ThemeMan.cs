...
namespace QuickLibraryPlus
{
	...
	{
		public const Theme FallbackTheme = Theme.Light;

		public static Theme CurrentTheme = FallbackTheme;
		...
		public static Theme GetSupportedTheme(int theme)
		{
			Theme themeCandidate = ToTheme(theme);

			if (!IsThemeSupported(themeCandidate))
			{
		...
		public static Theme ToTheme(int theme)
		{
			switch (theme)
			{
				default:
		...
		public static bool IsThemeSupported(Theme theme)
		{
			switch (theme)
			{
				default:
				case Theme.Light: return true;
				case Theme.Dark: return HasDarkThemeSupport();
			}
		}

		private static bool HasDarkThemeSupport()
		{
			if (IsWindows10())
			{
				try
